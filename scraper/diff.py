...
def load_results(country: str, 
                input_dir: str = "data/companies_by_country") -> List[Dict[str, Any]]:
    """
...
def compute_diff(country: str, 
    ...
    added = [new_map[l] for l in new_map if l not in old_map]
    removed = [old_map[l] for l in old_map if l not in new_map]
    ...
    report_path = os.path.join(report_dir, f"{country}_change.json")
